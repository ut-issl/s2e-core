...
template <size_t N>
RandomWalk<N>::RandomWalk(double step_width_s, const s2e::math::Vector<N>& standard_deviation, const s2e::math::Vector<N>& limit)
...
template <size_t N>
void RandomWalk<N>::DerivativeFunction(double x, const s2e::math::Vector<N>& state, s2e::math::Vector<N>& rhs) {
