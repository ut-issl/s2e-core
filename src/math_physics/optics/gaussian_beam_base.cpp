...
void GaussianBeamBase::SetPointingVector_i(const s2e::math::Vector<3> pointing_vector_i) { pointing_vector_i_ = pointing_vector_i; }

void GaussianBeamBase::SetBeamWaistPosition_i_m(const s2e::math::Vector<3> position_beam_waist_i_m) { position_beam_waist_i_m_ = position_beam_waist_i_m; }

double GaussianBeamBase::CalcBeamWidthRadius_m(double distance_from_beam_waist_m) {
  double rayleigh_length_m = s2e::math::pi * radius_beam_waist_m_ * radius_beam_waist_m_ / wavelength_m_;
...
double GaussianBeamBase::CalcIntensity_W_m2(double distance_from_beam_waist_m, double deviation_from_optical_axis_m) {
  ...
  double peak_intensity_W_m2 = (2.0 * total_power_W_) / (s2e::math::pi * beam_width_radius_m * beam_width_radius_m);
