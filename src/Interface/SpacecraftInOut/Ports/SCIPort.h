...
private:
	...
	RingBuffer* rxb_;	/// Reception from the viewpoint of on-board software (transmission from simulated component)
	RingBuffer* txb_;	/// Transmission from the viewpoint of the installed software (reception from the simulated component)
};
