...
Logger* InitLog(std::string file_name) {
  ...
  std::string log_file_path = ini_file.ReadString("SimulationSetting", "log_file_save_directory");
  bool log_ini = ini_file.ReadEnable("SimulationSetting", "save_initialize_files");
