...
// TCP通信に関しての参考URL
// - http://www.geocities.jp/playtown1056/program/index.htm // 2019/3/31以降閲覧不可能
// - https://web.archive.org/web/20181106125907/http://www.geocities.jp/playtown1056/program/index.htm // 上記Webページのアーカイブ
// - https://www.sbcr.jp/books/img/Linuxnet_02.pdf


COSMOS_TCP_IF::COSMOS_TCP_IF()
  :kPortNum(COSMOS_TCP_PORT_DEFAULT)
{
  is_connected_ = false;
}
