...
class HilsPortManager {
 public:
  ...
  virtual int UartConnectComPort(
  ...
  virtual int UartReceive(unsigned int port_id, unsigned char* buffer,
                          int offset, int count);
  // Uart Components -> Com ports
  virtual int UartSend(unsigned int port_id, const unsigned char* buffer,
                       int offset, int count);
  ...
  virtual int I2cTargetReadRegister(unsigned int port_id,
                                    const unsigned char reg_addr,
                                    unsigned char* data,
                                    const unsigned char len);
  virtual int I2cTargetWriteRegister(unsigned int port_id,
                                     const unsigned char reg_addr,
                                     const unsigned char* data,
                                     const unsigned char len);
  virtual int I2cTargetReadCommand(unsigned int port_id, unsigned char* data,
                                   const unsigned char len);
  ...
  virtual int I2cControllerConnectComPort(unsigned int port_id,
                                          unsigned int baud_rate,
                                          unsigned int tx_buf_size,
                                          unsigned int rx_buf_size);
  virtual int I2cControllerCloseComPort(unsigned int port_id);
  virtual int I2cControllerReceive(unsigned int port_id, unsigned char* buffer,
                                   int offset, int count);
  virtual int I2cControllerSend(unsigned int port_id,
