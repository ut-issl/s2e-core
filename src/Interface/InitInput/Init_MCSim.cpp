...
MCSimExecutor* InitMCSim(std::string file_name)
{
  ...
  enum Phase{
    FoundNothingYet,
    FoundSimulationObjectStr,
    FoundInitParameterStr
  };
  for (auto so_dot_ip_str : so_dot_ip_str_vec)
  {
    ...
    else if (!strcmp(rnd_type_str, "CartesianUniform")) rnd_type = InitParameter::CartesianUniform;
    else if (!strcmp(rnd_type_str, "CartesianNormal")) rnd_type = InitParameter::CartesianNormal;
    else if (!strcmp(rnd_type_str, "CircularNormalUniform")) rnd_type = InitParameter::CircularNormalUniform;
    else if (!strcmp(rnd_type_str, "CircularNormalNormal")) rnd_type = InitParameter::CircularNormalNormal;
    else if (!strcmp(rnd_type_str, "SphericalNormalUniformUniform")) rnd_type = InitParameter::SphericalNormalUniformUniform;
    else if (!strcmp(rnd_type_str, "SphericalNormalNormal")) rnd_type = InitParameter::SphericalNormalNormal;
    else if (!strcmp(rnd_type_str, "QuaternionUniform")) rnd_type = InitParameter::QuaternionUniform;
    else if (!strcmp(rnd_type_str, "QuaternionNormal")) rnd_type = InitParameter::QuaternionNormal;
