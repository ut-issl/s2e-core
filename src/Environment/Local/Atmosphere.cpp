...
Atmosphere::Atmosphere(string model, string fname, double gauss_stddev,
    ...
    : model_(model), fname_(fname), air_density_(0.0),
      gauss_stddev_(gauss_stddev), is_table_imported_(false),
      is_manual_param_used_(is_manual_param_used),
      manual_daily_f107_(manual_daily_f107),
      manual_average_f107_(manual_average_f107), manual_ap_(manual_ap) {
  if (model_ == "STANDARD") {
