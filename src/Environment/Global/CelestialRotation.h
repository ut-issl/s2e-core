...
public:
  ...
  CelestialRotation(const RotationMode rotation_mode, const string center_obj);
  // calculate rotation
...
private:
  ...
  void Init_CelestialRotation_As_Earth(const RotationMode rotation_mode, const string center_obj);
  ...
  string planet_name_;           // designate which solar planet the instance should work as 
