...
public:
  ...
  inline void TransECIToECEF(double current_jd)
  {
    ...
    Matrix<3, 3> trans_mat;  // ECI2ECEF transformation matrix representing the Earth's rotation according to Greenwich Sidereal Time.
...
protected:
  ...
  // Longitude [rad] East longitude: 0 to π, West longitude: 2π to π (i.e., defined as 0 to 2π [rad] east of the Greenwich meridian)
  double lon_rad_;
