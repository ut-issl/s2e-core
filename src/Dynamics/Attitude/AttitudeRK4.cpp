...
AttitudeRK4::AttitudeRK4(
  ...
  const double		prop_step_ini):SimulationObject("Attitude")
{
...
Matrix<4, 4> AttitudeRK4::Omega4Kinematics(Vector<3> omega)
{
  ...
  OMEGA[0][0] = 0.0f;       OMEGA[0][1] = omega[2];   OMEGA[0][2] = -omega[1];  OMEGA[0][3] = omega[0];
  OMEGA[1][0] = -omega[2];  OMEGA[1][1] = 0.0f;       OMEGA[1][2] = omega[0];   OMEGA[1][3] = omega[1];
  OMEGA[2][0] = omega[1];   OMEGA[2][1] = -omega[0];  OMEGA[2][2] = 0.0f;       OMEGA[2][3] = omega[2];
  OMEGA[3][0] = -omega[0];  OMEGA[3][1] = -omega[1];  OMEGA[3][2] = -omega[2];  OMEGA[3][3] = 0.0f;
...
{
  Vector<7> x;
  for (int i = 0; i < 3; i++){ x[i] = omega_b_[i]; }
  for (int i = 0; i < 4; i++){ x[i + 3] = quaternion_i2b_[i]; }
  ...
  for (int i = 0; i < 3; i++){ omega_b_[i] = next_x[i]; }
  for (int i = 0; i < 4; i++){ quaternion_i2b_[i] = next_x[i + 3]; }
