...
class Temperature : public logger::ILoggable {
 protected:
  ...
  const environment::EarthInfrared* earth_infrared_;                       //!< EarthInfrared object for calculating earth infrared radiation
 ...
 public:
   ...
   * @param earth_infrared: EarthInfrared object for calculating earth infrared radiation
