 ...
 */
Orbit* InitOrbit(const CelestialInformation* celestial_information, std::string ini_path, double stepSec, double current_time_jd, double gravity_constant,
 ...
 * @param [in] section: Section name
 */
Vector<6> InitializePosVel(std::string ini_path, double current_time_jd, double mu_m3_s2, std::string section = "ORBIT");
