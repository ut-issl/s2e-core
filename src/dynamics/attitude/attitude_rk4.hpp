...
class AttitudeRk4 : public Attitude {
 public:
   ...
   */
  AttitudeRk4(const s2e::math::Vector<3>& angular_velocity_b_rad_s, const s2e::math::Quaternion& quaternion_i2b, const s2e::math::Matrix<3, 3>& inertia_tensor_kgm2,
              const s2e::math::Vector<3>& torque_b_Nm, const double propagation_step_s, const std::string& simulation_object_name = "attitude");
  /**
   * @fn ~AttitudeRk4
   * @brief Destructor
   */
 ...
 private:
  ...
  s2e::math::Matrix<3, 3> inverse_inertia_tensor_;          //!< Inverse of inertia tensor
  s2e::math::Matrix<3, 3> previous_inertia_tensor_kgm2_;    //!< Previous inertia tensor [kgm2]
  s2e::math::Vector<3> torque_inertia_tensor_change_b_Nm_;  //!< Torque generated by inertia tensor change [Nm]
   ...
   */
  s2e::math::Vector<7> AttitudeDynamicsAndKinematics(s2e::math::Vector<7> x, double t);
  /**
