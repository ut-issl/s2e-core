...
class AttitudeWithCantileverVibrationOde : public InterfaceOde<13> {
 public:
   ...
   */
  inline libra::Vector<3> GetTorqueInertiaTensor_b_Nm() { return torque_inertia_tensor_b_Nm_; }
  /**
   * @fn GetInverseInertiaTensor
   * @brief Get inverse of inertia tensor
   */
  inline libra::Matrix<3, 3> GetInverseInertiaTensor() { return inverse_inertia_tensor_; }
  /**
   * @fn GetPreviousInertiaTensor_kgm2
   * @brief Get previous inertia tensor [kgm2]
   */
  inline libra::Matrix<3, 3> GetPreviousInertiaTensor_kgm2() { return previous_inertia_tensor_kgm2_; }
  /**
   * @fn GetInertiaTensorCantilever_kgm2
   * @brief Get inertia tensor of the cantilever [kgm2]
   */
  inline libra::Matrix<3, 3> GetInertiaTensorCantilever_kgm2() { return inertia_tensor_cantilever_kgm2_; }
  /**
   * @fn GetInverseEquivalentInertiaTensorCantilever
   * @brief Get inverse of inertia tensor of the cantilever
   */
  inline libra::Matrix<3, 3> GetInverseEquivalentInertiaTensorCantilever() { return inverse_equivalent_inertia_tensor_cantilever_; }
