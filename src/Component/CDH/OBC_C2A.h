...
public:
  ...
  bool GpioComponentRead (int port_id) override;  // return false when the port_id is not used
  // Static function for C2A
  static int  GpioWrite_C2A(int port_id, const bool is_high);
  static bool GpioRead_C2A (int port_id); // return false when the port_id is not used
