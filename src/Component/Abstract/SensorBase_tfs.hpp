...
SensorBase<N>::SensorBase(
  ...
  : scale_factor_(scale_factor), range_to_const_c_(range_to_const_c), range_to_zero_c_(range_to_zero_c),
  bias_c_(bias_c), n_rw_c_(rw_stepwidth, rw_stddev_c, rw_limit_c)
{
