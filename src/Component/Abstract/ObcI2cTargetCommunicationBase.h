...
class ObcI2cTargetCommunicationBase {
 public:
  ObcI2cTargetCommunicationBase(const unsigned int sils_port_id,
                                const unsigned char i2c_address, OBC* obc);
  ObcI2cTargetCommunicationBase(const unsigned int hils_port_id,
 ...
 protected:
  void ReadRegister(const unsigned char reg_addr, unsigned char* data,
                    const unsigned char len);
  void WriteRegister(const unsigned char reg_addr, const unsigned char* data,
                     const unsigned char len);
