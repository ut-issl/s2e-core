...
STT InitSTT(ClockGenerator* clock_gen, int sensor_id, const string fname, double compo_step_time, const Dynamics* dynamics,
  ...
  double sun_forbidden_angle_deg = STT_conf.ReadDouble(STTSection, "sun_forbidden_angle_deg");
  double sun_forbidden_angle_rad = sun_forbidden_angle_deg * libra::pi / 180.0;
  double earth_forbidden_angle_deg = STT_conf.ReadDouble(STTSection, "earth_forbidden_angle_deg");
  double earth_forbidden_angle_rad = earth_forbidden_angle_deg * libra::pi / 180.0;
  double moon_forbidden_angle_deg = STT_conf.ReadDouble(STTSection, "moon_forbidden_angle_deg");
