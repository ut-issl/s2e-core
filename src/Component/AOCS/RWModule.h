...
class RWModule {
 ...
 public:
  ...
  RWModule(double step_width, double angular_velocity_init_0, double inertia_0, double angular_velocity_upperlimit_init_0,
           double angular_velocity_lowerlimit_init_0, bool motor_drive_init_0, double angular_accelaration_init_0, double angular_velocity_init_1,
           double inertia_1, double angular_velocity_upperlimit_init_1, double angular_velocity_lowerlimit_init_1, bool motor_drive_init_1,
