...
MagTorquer::MagTorquer(const int prescaler, ClockGenerator *clock_gen,
    ...
    : ComponentBase(prescaler, clock_gen), id_(id), q_b2c_(q_b2c),
      q_c2b_(q_b2c_.conjugate()), scale_factor_(scale_factor), max_c_(max_c),
      min_c_(min_c), bias_c_(bias_c),
      n_rw_c_(rw_stepwidth, rw_stddev_c, rw_limit_c), mag_env_(mag_env) {
