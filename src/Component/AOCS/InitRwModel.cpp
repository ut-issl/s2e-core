...
RWModel InitRWModel(ClockGenerator* clock_gen, int actuator_id, std::string file_name, double prop_step, double compo_update_step) {
  ...
  RWModel rwmodel(prescaler, fast_prescaler, clock_gen, actuator_id, step_width, dt_main_routine, jitter_update_interval, inertia, max_torque, max_velocity, q_b2c,
...
RWModel InitRWModel(ClockGenerator* clock_gen, PowerPort* power_port, int actuator_id, std::string file_name, double prop_step,
  ...
  RWModel rwmodel(prescaler, fast_prescaler, clock_gen, power_port, actuator_id, step_width, dt_main_routine, jitter_update_interval, inertia, max_torque,
