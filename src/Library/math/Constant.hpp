...
DEFINE_MATH_CONSTANT(inv_pi,
                     0.318309886183790671537767526745028724L); /* 1/pi */
DEFINE_MATH_CONSTANT(inv_sqrtpi,
                     0.564189583547756286948079451560772586L); /* 1/sqrt(pi) */
