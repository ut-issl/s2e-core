...
*    mu          - gravitational parameter        km3 / s2		//地心重力定数
*
*  outputs       :
...
*    truelon     - true longitude            (ce) 0.0  to 2pi rad	//真の経度
*    lonper      - longitude of periapsis    (ee) 0.0  to 2pi rad	//近地点での経度？
*
*  locals        :
*    hbar        - angular momentum h vector      km2 / s
*    ebar        - eccentricity     e vector			//離心率のベクトル？
