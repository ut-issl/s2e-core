...
#include <windows.h>
#else
#include "../../ExtLibraries/inih/cpp/INIReader.h"
#endif
...
class IniAccess {
 public:
  ...
  void ReadVector(const char* section_name, const char* key_name, s2e::math::Vector<NumElement>& data);
  /**
   * @fn ReadStrVector
   ...
   */
  void ReadQuaternion(const char* section_name, const char* key_name, s2e::math::Quaternion& data);
  /**
   * @fn ReadChar
...
template <size_t NumElement>
void IniAccess::ReadVector(const char* section_name, const char* key_name, s2e::math::Vector<NumElement>& data) {
