...
#ifndef S2E_LIBRARY_MATH_ORDINARY_DIFFERENTIA_EQUATION_IMPL_H_
#define S2E_LIBRARY_MATH_ORDINARY_DIFFERENTIA_EQUATION_IMPL_H_
...
#endif  // S2E_LIBRARY_MATH_ORDINARY_DIFFERENTIA_EQUATION_IMPL_H_
