...
libra::Matrix<6, 6> CalcCarterStm(double orbit_radius_m, double gravity_constant_m3_s2, double f_ref_rad, double f_ref_0_rad, OrbitalElements* reference_oe){
  ...
  stm_inv[0][0] = 4*S2 + phi2_prime;
  stm_inv[0][1] = -phi2;
  stm_inv[0][2] = 0.0;
  stm_inv[0][3] = 2*S2;
  stm_inv[0][4] = 0.0;
  stm_inv[0][5] = 0.0;
  stm_inv[1][0] = -(4*S1 + phi1_prime);
  stm_inv[1][1] = phi1;
  stm_inv[1][2] = 0.0;
  stm_inv[1][3] = -2*S1;
  stm_inv[1][4] = 0.0;
  ...
  stm_inv[4][2] = 0.0;
  stm_inv[4][3] = 0.0;
  stm_inv[4][4] = cos(f_ref_rad);
  stm_inv[4][5] = -sin(f_ref_rad);
  stm_inv[5][0] = 0.0;
  stm_inv[5][1] = 0.0;
  stm_inv[5][2] = 0.0;
  stm_inv[5][3] = 0.0;
  stm_inv[5][4] = sin(f_ref_rad);
  stm_inv[5][5] = cos(f_ref_rad);
