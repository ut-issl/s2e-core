...
libra::Matrix<6, 6> CalcHillSystemMatrix(double orbit_radius_m, double mu_m3_s2) {
  libra::Matrix<6, 6> system_matrix;

  double n = sqrt(mu_m3_s2 / pow(orbit_radius_m, 3));
...
libra::Matrix<6, 6> CalcHcwStm(double orbit_radius_m, double mu_m3_s2, double elapsed_time_s) {
