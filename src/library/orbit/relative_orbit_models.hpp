 ...
 */
libra::Matrix<6, 6> CalcHillSystemMatrix(const double orbit_radius_m, const double mu_m3_s2);
 ...
 */
libra::Matrix<6, 6> CalcHcwStm(const double orbit_radius_m, const double mu_m3_s2, const double elapsed_time_s);
