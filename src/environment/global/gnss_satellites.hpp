...
class GnssSatellites : public ILoggable {
 public:
   ...
   */
  void Initialize(const std::vector<s2e::gnss::Sp3FileReader>& sp3_files, const time_system::EpochTime start_time);
 ...
 private:
   ...
   */
  bool GetCurrentSp3File(s2e::gnss::Sp3FileReader& current_sp3_file, const time_system::EpochTime current_time);
