...
#define S2E_SIMULATION_INTER_SPACECRAFT_COMMUNICATION_INTER_SPACECRAFT_COMMUNICATION_HPP_
...
#endif  // S2E_SIMULATION_INTER_SPACECRAFT_COMMUNICATION_INTER_SPACECRAFT_COMMUNICATION_HPP_
