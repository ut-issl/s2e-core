...
void InitializedMonteCarloParameters::CalcCircularNormalUniform(libra::Vector<2>& destination, double r_mean, double r_sigma, double theta_min,
                                                                double theta_max) {
...
void InitializedMonteCarloParameters::CalcCircularNormalNormal(libra::Vector<2>& destination, double r_mean, double r_sigma, double theta_mean,
                                                               double theta_sigma) {
...
void InitializedMonteCarloParameters::CalcSphericalNormalUniformUniform(libra::Vector<3>& destination, double r_mean, double r_sigma,
...
void InitializedMonteCarloParameters::CalcQuaternionUniform(libra::Quaternion& destination) {
...
void InitializedMonteCarloParameters::CalcQuaternionNormal(libra::Quaternion& destination, double theta_sigma) {
