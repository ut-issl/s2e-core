...
class Spacecraft {
 public:
   ...
   */
  Spacecraft(const SimulationConfiguration* simulation_configuration, const environment::GlobalEnvironment* global_environment, const int spacecraft_id,
   ...
   */
  virtual void Initialize(const SimulationConfiguration* simulation_configuration, const environment::GlobalEnvironment* global_environment,
