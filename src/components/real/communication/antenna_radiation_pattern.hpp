...
class AntennaRadiationPattern {
 public:
  ...
  AntennaRadiationPattern(const std::string file_path, const size_t length_theta = 360, const size_t length_phi = 181,
                          const double theta_max_rad = s2e::math::tau, const double phi_max_rad = s2e::math::pi);
 ...
 private:
  ...
  double theta_max_rad_ = s2e::math::tau;  //!< Maximum value of theta
  double phi_max_rad_ = s2e::math::pi;     //!< Maximum value of phi
