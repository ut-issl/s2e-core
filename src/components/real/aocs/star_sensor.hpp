...
class StarSensor : public Component, public logger::ILoggable {
 public:
   ...
   */
  inline const s2e::math::Quaternion GetMeasuredQuaternion_i2c() const { return measured_quaternion_i2c_; };
  /**
   * @fn GetErrorFlag
 ...
 protected:
  ...
  s2e::math::Quaternion measured_quaternion_i2c_ = {0.0, 0.0, 0.0, 1.0};  //!< StarSensor observed quaternion
  s2e::math::Vector<3> sight_direction_c_;                                //!< Sight direction vector at component frame
  s2e::math::Vector<3> first_orthogonal_direction_c;                      //!< The first orthogonal direction of sight at component frame
  ...
  std::vector<s2e::math::Quaternion> delay_buffer_;  //!< Buffer of quaternion for delay emulation
   ...
   */
  int SunJudgement(const s2e::math::Vector<3>& sun_b);
  /**
   * @fn EarthJudgement
   ...
   * @return 1: violated, 0: not violated
   */
  int MoonJudgement(const s2e::math::Vector<3>& moon_b);
  /**
   ...
   * @return 1: violated, 0: not violated
   */
  int CaptureRateJudgement(const s2e::math::Vector<3>& omega_b_rad_s);
  /**
   ...
   */
  double CalAngleVector_rad(const s2e::math::Vector<3>& vector1, const s2e::math::Vector<3>& vector2);
