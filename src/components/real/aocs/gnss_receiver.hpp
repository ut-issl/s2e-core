...
class GnssReceiver : public Component, public ILoggable {
 ...
 protected:
   ...
   */
  void CheckAntenna(const math::Vector<3> position_true_i_m, const libra::Quaternion quaternion_i2b);
  /**
   ...
   * @param [in] quaternion_i2b: True attitude of the spacecraft expressed by quaternion from the inertial frame to the body-fixed frame
   */
  void CheckAntennaSimple(const math::Vector<3> position_true_i_m, const libra::Quaternion quaternion_i2b);
  /**
   * @fn CheckAntennaCone
   ...
   * @param [in] quaternion_i2b: True attitude of the spacecraft expressed by quaternion from the inertial frame to the body-fixed frame
   */
  void CheckAntennaCone(const math::Vector<3> position_true_i_m, const libra::Quaternion quaternion_i2b);
  /**
   * @fn SetGnssInfo
   ...
   */
  void SetGnssInfo(const math::Vector<3> antenna_to_satellite_i_m, const libra::Quaternion quaternion_i2b, const size_t gnss_system_id);
  /**
   * @fn AddNoise
