...
class GyroSensor : public Component, public Sensor<kGyroDimension>, public ILoggable {
 public:
   ...
   */
  GyroSensor(const int prescaler, ClockGenerator* clock_generator, Sensor& sensor_base, const int sensor_id, const libra::Quaternion& quaternion_b2c,
   ...
   * @param [in] dynamics: Dynamics information
   */
  GyroSensor(const int prescaler, ClockGenerator* clock_generator, PowerPort* power_port, Sensor& sensor_base, const int sensor_id,
