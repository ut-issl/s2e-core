 ...
 * @brief Base class for GPIO communication with OnBoardComputer flight software
 * @note Components which want to communicate with OnBoardComputer using GPIO have to inherit this.
 */
class GpioConnectionWithObc {
 public:
  /**
 ...
 protected:
   ...
   * @param [in] index: element index for port_id_ vector, not the GPIO port ID for OnBoardComputer.
 ...
 private:
  ...
  OnBoardComputer* obc_;      //!< The communication target OnBoardComputer
};
