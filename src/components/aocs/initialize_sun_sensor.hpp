...
#ifndef S2E_COMPONENTS_AOCS_INITIALIZE_SUN_SENSOR_HPP_
#define S2E_COMPONENTS_AOCS_INITIALIZE_SUN_SENSOR_HPP_
...
#endif  // S2E_COMPONENTS_AOCS_INITIALIZE_SUN_SENSOR_HPP_
