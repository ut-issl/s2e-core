...
#ifndef S2E_COMPONENTS_POWER_INITIALIZE_SOLAR_ARRAY_PANEL_H_
#define S2E_COMPONENTS_POWER_INITIALIZE_SOLAR_ARRAY_PANEL_H_
...
#endif  // S2E_COMPONENTS_POWER_INITIALIZE_SOLAR_ARRAY_PANEL_H_
